...
/* Approved screens, in the order a person meets them.
   ...
   2026-09-15), D4 Batch review (approved 2026-09-15), D5 Batch render and finish (2026-09-15). */
const SCREENS = () => [typesScreen(), generateScreen(), batchScreen({ auto: true }), reviewScreen({ auto: true }), renderScreen({ auto: true })];
