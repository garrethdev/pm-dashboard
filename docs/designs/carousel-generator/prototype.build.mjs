 ...
 * Screens not approved yet show the Prototype note naming their ticket. Every screen, D1 to D10, is in.
 *
...
const SCREENS = () => [
  ...
  /* D9 History (approved 2026-09-16 after one review round): the History menu item opens it, as does History ›
     ...
     hand-off. */
  historyScreen(),
  /* D10 Trends (round one approved 2026-09-16; reopened for the feed and the search and round two approved
     2026-09-17 after four review rounds): the Trends menu item opens it on the Feed, the library's carousels from
     other creators, best-scored first. A rail on the left (a floating bar at the foot of the phone) switches between
     Feed, Digests, Knowledge and Saved; the search bar over the feed finds creators and carousels together, on
     Enter; Save keeps a post on the Saved section. Copy to Studio, on a post and on a digest's carousel, opens the
     Studio on that deck (Garreth, 2026-09-17): D6's update hook reads the deck it is handed and starts from it the
     way picking it from the saved decks does. */
  trendsScreen(),
];
