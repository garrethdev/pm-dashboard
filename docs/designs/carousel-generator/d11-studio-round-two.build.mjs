 ...
 *   FigmaDraft     the draft beside the frames; the AI proposes the set and facts the library lacks
 ...
 *
 * D14 (Garreth, 2026-09-21) adds no board of its own here: it gives every text box a Name, a Written by and a
 * measured character limit above Font, so TextOnBox and SharedSet are redrawn in place carrying that section, with
 * Set as a layered layer's fourth source. The rows Written by and Fact used to have of their own are gone.
 *
