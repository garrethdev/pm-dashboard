...
/**
 * SideRays — React Bits (https://reactbits.dev), TypeScript + Tailwind variant.
 *
 * Two changes from the published source:
 *
 *  - "use client", because every page here is a Server Component by default and
 *    this touches window and WebGL on mount.
 *  - A named export rather than a default, matching every other component in
 *    this codebase.
 *
 * It owns a WebGL context and an animation loop, so it belongs on the login
 * screen and nowhere that repeats. The IntersectionObserver in the original is
 * kept: it tears the context down when the element scrolls out of view.
 */
